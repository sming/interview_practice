...
public class ChangeCalculatorTest {
    ...
    @Test
    // https://en.wikipedia.org/wiki/Change-making_problem#Greedy_method
    // expected:<[2, 2, 2, 5, 10]> but was:<[20]>
    ...
    public void testChangeLessThanSmallestCoinInCurrencyCannotBeRepresented() {
        ...
        assertThat(expected).hasMessage("The total 3 cannot be represented in the given currency.");
    }
    ...
    public void testChangeLargerThanAllCoinsInCurrencyThatCannotBeRepresented() {
        ...
        assertThat(expected).hasMessage("The total 94 cannot be represented in the given currency.");
    }
    ...
    public void testNegativeChangeIsRejected() {
        ...
        assertThat(expected).hasMessage("Negative totals are not allowed.");
    }
